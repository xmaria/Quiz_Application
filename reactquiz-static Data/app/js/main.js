...
/***/ function(module, exports, __webpack_require__) {
	...
	var _QuestionList = __webpack_require__(161);

	var _QuestionList2 = _interopRequireDefault(_QuestionList);

	var _Scorebox = __webpack_require__(163);

	var _Scorebox2 = _interopRequireDefault(_Scorebox);

	var _Results = __webpack_require__(164);
	...
	var App = function (_Component) {
	    ...
	    _createClass(App, [{
	        ...
	        key: 'setChosen',
	        value: function setChosen(chosen) {
	        ...
	        value: function render() {
	            ...
	            if (this.state.current > this.state.questions.length) {
	                ...
	                var scorebox = '';
	                var results = _react2.default.createElement(_Results2.default, this.state);
	            } else {
	                var scorebox = _react2.default.createElement(_Scorebox2.default, this.state);
	                var results = '';
	            }
	            return _react2.default.createElement(
	                ...
	                null,
	                scorebox,
	                _react2.default.createElement(_QuestionList2.default, _extends({}, this.state, { setCurrent: this.setCurrent.bind(this),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Question = __webpack_require__(162);
	...
	var QuestionList = function (_Component) {
	    ...
	    function QuestionList() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(QuestionList).apply(this, arguments));
	    }
	...
	var Question = function (_Component) {
	    ...
	    _createClass(Question, [{
	        ...
	        value: function onChange(e) {
	            var setChosen = this.props.setChosen;
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    this.props.question.choices.map(function (choice) {
	                        return _react2.default.createElement(
	                            ...
	                            choice.id,
	                            " ",
	                            _react2.default.createElement("input", { type: "radio", name: _this2.props.question.id, value: choice.id, onChange: _this2.onChange.bind(_this2) }),
	                            choice.text
	                        );
	                    })
	                ),
	                _react2.default.createElement(
	                    "button",
	                    { type: "button", className: "btn btn-primary ", onClick: this.onClick.bind(this) },
	                    buttonName
	                )
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Scorebox = function (_Component) {
	    ...
	    function Scorebox() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Scorebox).apply(this, arguments));
	    }
